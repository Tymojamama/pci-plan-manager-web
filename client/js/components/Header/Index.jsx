...
var Header = React.createClass({
  ...
  componentDidMount: function() {
    ...
    $(document).mouseup(function(e) {
      if ((!$("#header-navigation-notifications-panel").is(e.target) || $("#header-navigation-notifications-panel").has(e.target).length === 0) && $(".header-navigation-notifications-button").has(e.target).length === 0) {
    ...
    return (
      <div>
        <div className="header-navigation">
          <div id="header-navigation-summary" style={{
          ...
          <div className="col-lg-8 col-md-12 col-sm-12 col-xs-12 col-centered">
            ...
            <span className="header-navigation-menu">
              <span className="hidden-xs">
                ...
                <span className="header-navigation-notifications-button" style={{
                  width: "100%"
                }}>
          ...
          <div id="header-navigation-settings-panel" className="header-navigation" style={{
            backgroundColor: "#0e2e47",
            display: "none",
            boxShadow: "0px 5px 5px rgba(0,0,0,.5)"
          }}>
            <div className="col-lg-8 col-md-12 col-sm-12 col-xs-12 col-centered">
              <div className="hidden-lg hidden-md hidden-sm" style={{
                width: "100%"
              }}>
        ...
        <div id="header-navigation-notifications-panel" className="header-navigation" style={{
  ...
  getNotificationLabel: function(isMobile) {
    var numberNotifications = this.state.tasks.length;
