  ...
  render: function() {
    return (
      <div style={Style.headerPadding}>
        <div id="home-dashboard" className="row-fluid" style={{
          display: "none"
        }}>
          <div className="col-lg-8 col-md-12 col-sm-12 col-xs-12 col-centered"></div>
        </div>
          ...
          <div className="col-lg-8 col-md-12 col-sm-12 col-xs-12 col-centered">
            ...
            <div className="row-fluid">
              <div className="col-lg-9 col-md-9 col-sm-12 col-xs-12" style={{
                ...
                <div className="col-lg-8 col-md-8" style={{
                  padding: "0px",
                  margin: "0px"
                }}>
                  <Feed/>
                </div>
                <div className="col-lg-4 col-md-4 hidden-sm hidden-xs" style={{
                  paddingRight: "0px",
                  marginRight: "0px"
                }}>
                  <Actions options={{
