      ...
      <div>
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="row-fluid padding-top-15">
              <span className="col-md-4 hidden-sm hidden-xs text-right">Is Active</span>
              <span className="hidden-lg hidden-md col-xs-12 text-left">Is Active</span>
              <span className="col-md-8 col-xs-12">
                <Select
                  options={["true","false"]}
                  attribute={"isActive"}
                  value={this.state.task.isActive}
                  onChange={this.handleChange_Attribute}/>
              </span>
            </div>
            <div className="row-fluid padding-top-15">
              <span className="col-md-4 hidden-sm hidden-xs text-right">Status</span>
              <span className="hidden-lg hidden-md col-xs-12 text-left">Status</span>
              <span className="col-md-8 col-xs-12">
                <Select
